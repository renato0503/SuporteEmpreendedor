    ...
    <div id="home-page" class="page-content bg-slate-50">
      ...
      <section id="servicos-container" class="py-24 md:py-32 bg-white relative">
        ...
        <div class="max-w-7xl mx-auto px-4 lg:px-8 relative">
           <div class="text-center mb-16">
            <h2 class="text-base font-black text-cta-600 uppercase tracking-[0.2em] mb-4 text-center">Portfólio de Soluções</h2>
            <h3 class="text-3xl md:text-5xl font-black text-slate-900 leading-tight text-center">Serviços que fazem sua <br/> empresa decolar.</h3>
          </div>
      ...
      <section class="py-24 bg-[#0A192F] relative overflow-hidden">
        ...
        <div class="max-w-4xl mx-auto px-4 text-center relative z-10">
          <div class="w-20 h-20 bg-cta-500/20 rounded-3xl flex items-center justify-center mx-auto mb-8 shadow-xl border border-cta-500/20">
            <svg class="w-10 h-10 text-cta-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z"></path></svg>
          </div>
          ...
          <p class="text-primary-200/80 mb-12 text-lg leading-relaxed max-w-xl mx-auto">
            Nossa equipe técnica está pronta para analisar sua situação e propor o melhor caminho. Atendimento humanizado e direto via WhatsApp.
          </p>
          <a 
